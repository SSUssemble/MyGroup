    ...
    public void setting(TextView text1, TextView text2, SlidingDrawer drawer, AutoResizeTextView[] monday,AutoResizeTextView[] tuesday,AutoResizeTextView[] wednesday,AutoResizeTextView[] thursday,AutoResizeTextView[] friday, Context context) {
        ...
        for(int i=0;i<14;i++)
        {
            if(!this.monday[i].equals(""))
            {
                ...
                monday[i].setTextColor(context.getResources().getColor(R.color.black));
            ...
            if(!this.tuesday[i].equals(""))
            {
                ...
                tuesday[i].setTextColor(context.getResources().getColor(R.color.black));
            ...
            if(!this.wednesday[i].equals(""))
            {
                ...
                wednesday[i].setTextColor(context.getResources().getColor(R.color.black));
            ...
            if(!this.thursday[i].equals(""))
            {
                ...
                thursday[i].setTextColor(context.getResources().getColor(R.color.black));
            ...
            if(!this.friday[i].equals(""))
            {
                ...
                friday[i].setTextColor(context.getResources().getColor(R.color.black));
